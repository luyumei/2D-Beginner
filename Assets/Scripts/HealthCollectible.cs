...
public class HealthCollectible : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        RubyController controller = other.GetComponent<RubyController>(); // Access the RubyController component on the GameObject of the Collider that enters the Trigger
                                ...
                                // Doing this test ensures that you are only giving health to Ruby, and not creating an error trying to do it on other objects.
        {
            ...
            {
                controller.ChangeHealth(1); // changed the health of the RubyController by 1 with the function you wrote earlier
